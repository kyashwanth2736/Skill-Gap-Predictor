(() => {
    ...
    const state = {
        ...
        extractedSkills: Array.isArray(APP.extractedSkills) ? APP.extractedSkills : [],
        requiredSkills: Array.isArray(APP.requiredSkills) ? APP.requiredSkills : [],
    ...
    function initThemeToggle() {
        ...
        if (!toggle) {
            toggle = qs(
                ".theme-toggle, .dark-toggle, .mode-toggle"
            );
        }
    ...
    function renderATS() {
        ...
        qsa(
            "#ats-score, #atsScore, #ats-score-value"
        ).forEach(element => {
            element.textContent =
                Math.round(score) +
                "%";
    ...
    function renderRecommendation(job) {
        ...
        qsa(
            "#recommended-job, #job-recommendation, #recommendedJob"
        ).forEach(container => {
            container.innerHTML = `
